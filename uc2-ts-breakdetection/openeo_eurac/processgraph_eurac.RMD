...
# timings
Timings taken from the webeditor interface.

test.tif 
```{r, timing_test}
a = strptime("2022-11-03 15:02:07 UTC", "%Y-%m-%d %H:%M:%S")
b = strptime("2022-11-03 15:04:02 UTC", "%Y-%m-%d %H:%M:%S")
a-b
```

vaja.tif
```{r, timing_vaja}
a = strptime("2022-11-03 15:47:21 UTC", "%Y-%m-%d %H:%M:%S")
b = strptime("2022-11-03 15:04:02 UTC", "%Y-%m-%d %H:%M:%S")
a-b
```
